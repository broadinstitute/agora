...
import org.broadinstitute.dsde.agora.server.acls.AclTranslatorTest
...
class AgoraTestSuite extends Suites(
  ...
  new AclTranslatorTest) with AgoraTestData with BeforeAndAfterAll with MongoEmbedDatabase {
